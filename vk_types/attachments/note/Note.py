...
class Note:
    def __init__(self, note_id: int, owner_id: int, title: str, text: str,
                 unix_date: int, comments: int, read_comments: int | None,
                 view_url: str, privacy_view: str, can_comment: bool, text_wiki: str):
        """
        Represents a note.

        :param note_id: Unique identifier of the note.
        :param owner_id: ID of the user who owns the note.
        :param title: Title of the note.
        :param text: Text content of the note.
        :param unix_date: Timestamp of when the note was created (UNIX format).
        :param comments: Number of comments on the note.
        :param read_comments: Number of read comments on the note (if available).
        ...
        self.amount_of_comments = comments
        self.amount_of_read_comments = read_comments
