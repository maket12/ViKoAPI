...
class WikiPage:
    def __init__(self, page_id: int, group_id: int, creator_user_id: int, title: str,
                 can_edit: bool, can_edit_access: bool, who_can_view: int,
                 who_can_edit: int, created_unix: int, edited_unix: int,
                 editor_user_id: int, views: int, parent: str | None, parent2: str | None,
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "creator_id": self.creator_user_id,
            "title": self.title,
